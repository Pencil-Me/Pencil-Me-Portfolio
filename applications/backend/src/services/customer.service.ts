...
import {convertICustomerToTCustomer, type ICustomer, type TCustomer} from "@/views/Customers/CustomerTypes";
...
class CustomerService {
  ...
  async updateCustomer(payload: ICustomer) {
    ...
    return await
      this.axiosInstance
        .put('customer/' + payload.id, sendobject)
        .then((response) => {
          return response.data
        })
  }
